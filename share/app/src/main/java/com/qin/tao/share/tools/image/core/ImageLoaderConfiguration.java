...
import com.qin.tao.share.tools.image.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.qin.tao.share.tools.image.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration
{
	...
	private final String diskCacheDirPath;
	final boolean disabledToDuplicateLoadUriToDisplayImageAware;
	...
	private ImageLoaderConfiguration(final Builder builder)
	{
		...
		//XXX 米虫.扩展 Add by xjunjie@gmail.com
		diskCacheDirPath = builder.diskCacheDirPath;
		disabledToDuplicateLoadUriToDisplayImageAware = builder.disabledToDuplicateLoadUriToDisplayImageAware;
	}
	...
	public static class Builder
	{
		...
		private boolean disabledToDuplicateLoadUriToDisplayImageAware = false;
		 ...
		 * 缓存文件夹路径
		 *
		 * @param diskCacheDirPath 缓存文件夹路径
		 */
		public Builder diskCacheDirPath(String diskCacheDirPath)
		{
		...
		/**
		 * 禁止图片重复加载显示
		 * Add by xjunjie@gmail.com 2016.11.02
		 */
		public Builder disabledToDuplicateLoadUriToDisplayImageAware()
		{
			this.disabledToDuplicateLoadUriToDisplayImageAware = true;
			return this;
		}
		...
		private void initEmptyFieldsWithDefaultValues()
		{
			...
			if (diskCache == null)
			{
				...
				diskCache = DefaultConfigurationFactory.createDiskCache(context,diskCacheDirPath, diskCacheFileNameGenerator, diskCacheSize, diskCacheFileCount);
			}
			if (memoryCache == null)
			{
