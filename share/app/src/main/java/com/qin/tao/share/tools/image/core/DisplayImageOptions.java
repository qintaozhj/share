...
import com.qin.tao.share.tools.image.core.assist.ImageScaleType;
...
public final class DisplayImageOptions
{
	...
	private final boolean isDuplicateLoadUriToDisplay;

	private DisplayImageOptions(Builder builder)
	{
		imageResOnLoading = builder.imageResOnLoading;//设置图片下载期间显示的图片 
		imageResForEmptyUri = builder.imageResForEmptyUri;//资源为空
		imageResOnFail = builder.imageResOnFail;//加载失败
		imageOnLoading = builder.imageOnLoading;//加载中显示
		imageForEmptyUri = builder.imageForEmptyUri;//设置图片Uri为空或是错误的时候显示的图片 
		imageOnFail = builder.imageOnFail;//加载失败
		resetViewBeforeLoading = builder.resetViewBeforeLoading;//
		cacheInMemory = builder.cacheInMemory;//内存缓存
		cacheOnDisk = builder.cacheOnDisk;//磁盘缓存
		imageScaleType = builder.imageScaleType;//缩放类型
		decodingOptions = builder.decodingOptions;
		delayBeforeLoading = builder.delayBeforeLoading;//加载之前显示
		...
		isSyncLoading = builder.isSyncLoading;//异步加载
		isDuplicateLoadUriToDisplay = builder.isDuplicateLoadUriToDisplay;//相同在线 Uri 是否重复加载
	}
	...
	/**
	 * 相同在线 Uri 是否重复加载.默认 true :重复加载  , false:不重复加载
	 * @return
	 */
	public boolean isDuplicateLoadUriToDisplay()
	{
		return this.isDuplicateLoadUriToDisplay;
	}
	...
	{
		public boolean isDuplicateLoadUriToDisplay = true;
		...
		/**
		 * 相同在线 Uri 是否重复加载.默认 true :重复加载  , false:不重复加载
		 * @param isDuplicateLoadUriToDisplay
		 */
		public Builder setDuplicateLoadUriToDisplay(boolean isDuplicateLoadUriToDisplay)
		{
			this.isDuplicateLoadUriToDisplay = isDuplicateLoadUriToDisplay;
			return this;
		}
