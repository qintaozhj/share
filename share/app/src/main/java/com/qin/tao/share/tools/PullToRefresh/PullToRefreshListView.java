 ...
 *******************************************************************************/
package com.qin.tao.share.tools.PullToRefresh;
...
import com.qin.tao.share.tools.PullToRefresh.internal.EmptyViewMethodAccessor;
import com.qin.tao.share.tools.PullToRefresh.internal.LoadingLayout;

public class PullToRefreshListView extends PullToRefreshAdapterViewBase<BaseListView>
{
	...
	protected BaseListView createListView(Context context, AttributeSet attrs)
	{
		final BaseListView lv;
	...
	{
		BaseListView lv = createListView(context, attrs);
	...
	protected class InternalListView extends BaseListView implements EmptyViewMethodAccessor
	{
