...
import com.qin.tao.share.tools.image.core.assist.FailReason.FailType;
...
import com.qin.tao.share.tools.image.core.decode.ImageDecodingInfo;
import com.qin.tao.share.tools.image.core.download.ImageDownloader;
import com.qin.tao.share.tools.image.core.download.ImageDownloader.Scheme;
...
import com.qin.tao.share.tools.image.utils.IoUtils;
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener
{
	...
	private final boolean disabledToDuplicateLoadUriToDisplayImageAware;
	...
	public LoadAndDisplayImageTask(ImageLoaderEngine engine, ImageLoadingInfo imageLoadingInfo, Handler handler)
	{
		...
		disabledToDuplicateLoadUriToDisplayImageAware = configuration.disabledToDuplicateLoadUriToDisplayImageAware;
	...
	private Bitmap tryLoadBitmap() throws TaskCancelledException
	{
		...
		try
		{
			...
			if (imageFile != null && imageFile.exists() && imageFile.length() > 0)
			{
				...
				L.d("%1$s -> %2$s", imageFile.getAbsolutePath(), uri);
