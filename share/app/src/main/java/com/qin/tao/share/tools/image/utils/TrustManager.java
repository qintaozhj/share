...
public class TrustManager implements javax.net.ssl.TrustManager, X509TrustManager {
    ...
    public static SSLContext createSslContextForTrustedCertificates() {
        ...
        trustAllCerts[0] = tm;
        SSLContext returnValue = null;

        try {
            returnValue = SSLContext.getInstance("TLS");
        } catch (NoSuchAlgorithmException var15) {
            //Logger.i("TrustManager", "NoSuchAlgorithmException TLS");

            try {
                returnValue = SSLContext.getInstance("SSL");
            ...
            if (returnValue != null) {
                try {
                    returnValue.init((KeyManager[]) null, trustAllCerts, new SecureRandom());
    ...
    private static HcVerifier gHcVerifier;

    public static HcVerifier getHostnameVerifier() {
        if (gHcVerifier == null) {
            synchronized (HcVerifier.class) {
                if (gHcVerifier == null)
                    gHcVerifier = new HcVerifier();
            }
        }
        return gHcVerifier;
    }

    public final static class HcVerifier implements HostnameVerifier {
        ...
        protected boolean verifyAsIpAddress(String host) {
        ...
        public boolean verify(String host, SSLSession session) {
            ...
            try {
                ...
                returnValue = verify(host, (X509Certificate) certificates[0]);
