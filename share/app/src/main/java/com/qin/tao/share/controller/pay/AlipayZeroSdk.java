package com.qin.tao.share.controller.pay;
...
/**
 * @author qintao on 2017/9/13 10:41
 * 实用于个人开发者打赏
 */
...
public class AlipayZeroSdk {
     ...
     * @param urlCode  手动解析二维码获得地址中的参数，例如 https://qr.alipay.com/aehvyvf4taua18zo6e 最后那段 我的:HTTPS://QR.ALIPAY.COM/FKX08543PUUVPPESYCUP3C
     * @return 是否成功调用
     */
